...
# ---------- Отмена для любых состояний (исправлено) ----------
...
# --- Редактирование заявки продавца ---
...
@router.message(StateFilter("edit_seller_price"))
...
@router.message(StateFilter("edit_seller_desc"))
